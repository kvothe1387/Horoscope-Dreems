import { retrieveUserData, appendUserDataToTable } from './utils.js';
import { saveUserDataToLocal, loadUserDataFromLocal } from './localStorage.js';
...
document.getElementById('submitUserData').addEventListener('click', handleUserData);
